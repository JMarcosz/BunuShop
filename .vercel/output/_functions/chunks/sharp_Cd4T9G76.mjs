import { N as NoImageMetadata, Y as UnsupportedImageFormat, Z as AstroError, j as MissingSharp } from "./errors-data_BMFRmUnV.mjs";
import { r as detector } from "./remoteProbe_C_S_-Hl-.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_BKKtSHMb.mjs";
//#region node_modules/.pnpm/astro@7.3.1_@emnapi+core@1._3b90ec98b07d1cc645f862768eddd890/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_CBTJZujt.mjs")).default;
	} catch {
